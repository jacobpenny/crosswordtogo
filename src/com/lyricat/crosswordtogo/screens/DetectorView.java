...
public class DetectorView extends JavaCameraView {
    ...
    public List<Integer> matToBlocks(Mat mat) {
    	List<Integer> result = new ArrayList<Integer>();
    	final org.opencv.core.Size size = new org.opencv.core.Size(11, 11);
    	Mat workingCopy = mat.clone();
    	//GaussianBlur(workingCopy, workingCopy, size, 0);
    	return result;
    }
