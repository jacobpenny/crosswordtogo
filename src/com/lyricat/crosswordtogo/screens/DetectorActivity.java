...
public class DetectorActivity extends Activity implements CvCameraViewListener2, OnTouchListener {
    ...
    private DetectorView mOpenCvCameraView;
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    mOpenCvCameraView.setOnTouchListener(DetectorActivity.this);
                } break;
                default:
                {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detector_surface_view);

        mOpenCvCameraView = (DetectorView) findViewById(R.id.detector_activity_java_surface_view);
